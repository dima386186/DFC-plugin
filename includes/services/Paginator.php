...
class Paginator {
    ...
    public function page_links($path='?',$ext=null)
    {
        ...
        if($lastpage > 1)
        {
            $pagination .= "<ul class='pagination-dcf'>";
            if ($this->_page > 1)
                $pagination.= "<li><a href='".$path."$this->_instance=$prev"."$ext'>Предыдущая</a></li>";
            else
            ...
            if ($this->_page < $counter - 1)
                $pagination.= "<li><a href='".$path."$this->_instance=$next"."$ext'>Следующая</a></li>";
            else
                $pagination.= "<li><span class='disabled'>Следующая</span></li>";
            $pagination.= "</ul>\n";
        }
        return $pagination;
    }
